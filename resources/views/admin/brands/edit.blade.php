...
@section('section')
    <div class="pcoded-inner-content">
        ...
        <form action="{{ route('admin.brands.update', ['id' => $data->id]) }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="f1" class="fm-field"> <x-filemanager-field name="file_id" label="Лого" id="f1" value="{{ $data->file_id }}"></x-filemanager-field> </div>

                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <ul class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript:">Наша команда</a></li>
                                </ul>
                            </div>
                            <a href="{{ route('admin.teams.create') }}" class="btn btn-primary mr-0">Добавить</a>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    @foreach($data as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a
                                                    href="{{ route('admin.teams.destroy', ['id' => $item->id]) }}"

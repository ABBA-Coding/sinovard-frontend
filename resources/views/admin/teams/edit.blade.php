...
@section('section')
    <div class="pcoded-inner-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.teams.index') }}">Наша команда</a></li>
        ...
        <form action="{{ route('admin.teams.update', ['id' => $data->id]) }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-0">
                                ...
                                <input type="text"
                                       name="position"
                                       class="form-control"
                                       value="{{ old('position') ?? @$data->translate->position }}"
                                       autocomplete="off"
                                       title="">
                            </div>

...
@section('section')
    <div class="pcoded-inner-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.advantages.index') }}">Преимущества</a></li>
        ...
        <form action="{{ route('admin.advantages.update', ['id' => $data->id]) }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}

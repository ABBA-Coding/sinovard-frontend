                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <a href="{{ route('admin.stocks.create') }}" class="btn btn-primary mr-0">Добавить</a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                @if (count($data) > 0)
                                    @foreach($data as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.stocks.edit', ['id' => $item->id]) }}"
                                                   class="label theme-bg text-white f-12 mb-0">Изменить
                                                </a>
                                                <a
                                                    href="{{ route('admin.stocks.destroy', ['id' => $item->id]) }}"

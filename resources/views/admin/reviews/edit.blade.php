...
@section('section')
    <div class="pcoded-inner-content">
        ...
        <form action="{{ route('admin.reviews.update', ['id' => $data->id]) }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                       name="company_name"
                                       class="form-control"
                                       value="{{ old('company_name') ??  @$data->translate->company_name }}"
                                       autocomplete="off"
                                       title="">
                            </div>
                            ...
                            <div class="form-group mb-0">
                                ...
                                <textarea class="form-control" title=""
                                          name="comment">{!! old('comment') ?? @$data->translate->comment !!}</textarea>
                            </div>

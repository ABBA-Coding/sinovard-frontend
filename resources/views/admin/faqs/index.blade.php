                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <ul class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript:">F.A.Q</a></li>
                                </ul>
                            </div>
                            <a href="{{ route('admin.faqs.create') }}" class="btn btn-primary mr-0">Добавить</a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                @if (count($data) > 0)
                                    @foreach($data as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.faqs.edit', ['id' => $item->id]) }}"
                                                   class="label theme-bg text-white f-12 mb-0">Изменить
                                                </a>
                                                <a
                                                    href="{{ route('admin.faqs.destroy', ['id' => $item->id]) }}"

                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <a href="{{ route('admin.banners.create') }}" class="btn btn-primary mr-0">Добавить</a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                @if (count($data) > 0)
                                    @foreach($data as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                {{ \App\Models\Banner::getTypeLabel($item->type) }}
                                            </td>
                                            <td>
                                                {!! $item->statusUi !!}
                                            </td>
                                            <td>
                                                ...
                                                <a
                                                    href="{{ route('admin.banners.destroy', ['id' => $item->id]) }}"

                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <ul class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript:">Новости</a></li>
                                </ul>
                            </div>
                            <a href="{{ route('admin.posts.create') }}" class="btn btn-primary mr-0">Добавить</a>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    @foreach($data as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a
                                                    href="{{ route('admin.posts.destroy', ['id' => $item->id]) }}"
